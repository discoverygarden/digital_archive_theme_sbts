...
<?php endif; ?>
    ...
    <div id="navigation" class="fixed-width">

      <?php if ($main_menu): ?>
        <nav id="main-menu"  class="fixed-width" role="navigation" tabindex="-1">
          <?php
...
<div class="slideshow-region-wrapper solid-background">
    <div id="slideshow" class="slideshow-region fixed-width">
